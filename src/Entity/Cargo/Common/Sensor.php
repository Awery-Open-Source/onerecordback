...
namespace App\Entity\Cargo\Common;

use ApiPlatform\Metadata\ApiResource;
use App\Attribute\Version;
use App\Entity\Cargo\Abstract\PhysicalLogisticsObject;
use App\Entity\Cargo\Embedded\Measurement;
use App\Entity\Cargo\Enum\SensorType;
...
class Sensor extends PhysicalLogisticsObject
{
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: SensorType::class)]
