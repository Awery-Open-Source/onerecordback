...
namespace App\Entity\Cargo\DG;

use ApiPlatform\Metadata\ApiResource;
use App\Attribute\Version;
use App\Entity\Cargo\Core\Product;
use App\Entity\CoreCodeLists\ExplosiveCompatibilityGroupCode;
use App\Entity\CoreCodeLists\PackagingDangerLevelCode;
