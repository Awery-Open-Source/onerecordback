...
namespace App\Entity\Cargo\Embedded;

use ApiPlatform\Metadata\ApiResource;
use App\Attribute\Version;
use App\Entity\Cargo\Enum\DirectionType;
use App\Entity\Cargo\Enum\MovementTimeType;
use App\Entity\CoreCodeLists\MovementIndicator;
...
class MovementTime
{
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: DirectionType::class)]
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: MovementTimeType::class)]
