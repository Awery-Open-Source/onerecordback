...
use App\Entity\Cargo\Embedded\OtherIdentifier;
...
use App\Entity\Cargo\Embedded\VolumetricWeight;
use App\Entity\Cargo\Enum\LoadType;
use App\Entity\CoreCodeLists\PackageMarkCode;
...
class Piece extends PhysicalLogisticsObject
{
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: LoadType::class)]
