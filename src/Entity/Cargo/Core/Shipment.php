...
//    protected Collection $pieces;
    ...
    #[ORM\ManyToMany(targetEntity: Piece::class, mappedBy: 'ofShipment', fetch: 'LAZY')]
    protected Collection $pieces;
     ...
     */
    #[ORM\ManyToOne(targetEntity: Waybill::class, fetch: 'EAGER')]
