...
namespace App\Entity\Cargo\Core;

use ApiPlatform\Metadata\ApiResource;
use App\Attribute\Version;
use App\Entity\Cargo\Abstract\LogisticsObject;
use App\Entity\Cargo\BillingSettlement\BillingDetails;
use App\Entity\Cargo\Common\Location;
use App\Entity\Cargo\Embedded\AccountingNote;
use App\Entity\Cargo\Embedded\CodeListElement;
use App\Entity\Cargo\Embedded\CurrencyValue;
use App\Entity\Cargo\Embedded\OtherCharge;
use App\Entity\Cargo\Embedded\Party;
use App\Entity\Cargo\Embedded\WaybillLineItem;
use App\Entity\Cargo\Enum\WaybillType;
use App\Entity\Cargo\Service\Booking;
use App\Entity\CoreCodeLists\ChargeCode;
use App\Entity\CoreCodeLists\PrepaidCollectIndicator;
use App\Entity\CoreCodeLists\ServiceCode;
...
class Waybill extends LogisticsObject
{
     ...
     */
    #[ORM\OneToOne(targetEntity: Shipment::class, fetch: 'EAGER')]
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: WaybillType::class)]
