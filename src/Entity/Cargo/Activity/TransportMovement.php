...
namespace App\Entity\Cargo\Activity;

use ApiPlatform\Metadata\ApiResource;
use App\Attribute\Version;
use App\Entity\Cargo\Abstract\LogisticsActivity;
use App\Entity\Cargo\Action\Loading;
use App\Entity\Cargo\Common\Location;
use App\Entity\Cargo\Core\CO2Emissions;
use App\Entity\Cargo\Core\TransportMeans;
use App\Entity\Cargo\Embedded\MovementTime;
use App\Entity\Cargo\Embedded\Party;
use App\Entity\Cargo\Embedded\Value;
use App\Entity\Cargo\Enum\ModeQualifier;
use App\Entity\CoreCodeLists\ModeCode;
...
class TransportMovement extends LogisticsActivity
{
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: ModeQualifier::class)]
