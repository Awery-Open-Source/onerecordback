...
namespace App\Entity\Cargo\Event;
...
use App\Entity\Cargo\Common\ExternalReference;
...
//    protected ?CodeListElement $eventCode = null;
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: EventTimeType::class)]
     ...
     * @return static
     */
    public function setEventCode($eventCode): static
    {
