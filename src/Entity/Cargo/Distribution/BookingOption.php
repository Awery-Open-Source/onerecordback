...
use App\Entity\Cargo\Agent\Carrier;
use App\Entity\Cargo\Embedded\BookingTimes;
use App\Entity\Cargo\Embedded\CarrierProduct;
use App\Entity\Cargo\Embedded\StationRemarks;
use App\Entity\Cargo\Embedded\UnitsPreference;
use App\Entity\Cargo\Enum\BookingOptionStatus;
...
class BookingOption extends LogisticsObject
{
     ...
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: BookingOptionStatus::class)]
