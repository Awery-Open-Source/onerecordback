...
namespace App\Entity\Cargo\Distribution;

use ApiPlatform\Metadata\ApiResource;
use App\Attribute\Version;
use App\Entity\Cargo\Abstract\LogisticsObject;
use App\Entity\Cargo\Embedded\CodeListElement;
use App\Entity\Cargo\Embedded\PieceGroup;
use App\Entity\Cargo\Embedded\TemperatureInstructions;
use App\Entity\CoreCodeLists\CommodityCode;
use App\Entity\CoreCodeLists\DensityGroupCode;
use App\Entity\CoreCodeLists\SpecialHandlingCode;
...
class BookingShipment extends LogisticsObject
{
     ...
     *
     * @link https://onerecord.iata.org/ns/cargo#densityGroupCode Ontology
     */
    #[ORM\Column(type: 'string', nullable: true, enumType: DensityGroupCode::class)]
    protected ?DensityGroupCode $densityGroupCode = null;
    ...
    /**
     * @return DensityGroupCode|null
     */
    public function getDensityGroupCode(): ?DensityGroupCode
    {
        return $this->densityGroupCode;
    }


    /**
     * @param DensityGroupCode|null $densityGroupCode
     * @return static
     */
    public function setDensityGroupCode(?DensityGroupCode $densityGroupCode): static
    {
